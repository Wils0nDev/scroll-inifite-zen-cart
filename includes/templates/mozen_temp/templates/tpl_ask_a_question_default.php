...
<label class="inputLabel" for="telefono"><?php echo "Teléfono:"; ?></label>
<?php echo zen_draw_input_field('telefono', $telefono, ' size="40" id="telefono"') . '<span class="alert"></span>'; ?>
<br class="clearBoth" />
...
<?php echo zen_draw_checkbox_field('privacy_conditions', '1', false, 'id="privacy_conditions"');?>
<label class="checkboxLabel" for="privacy_conditions"><?php echo TEXT_PRIVACY_CONDITIONS_CONFIRM;?></label>
