...
<!--bof Form start-->
<?php echo zen_draw_form('cart_quantity', zen_href_link('contact_us','', $request_type), 'post', 'enctype="multipart/form-data"') . "\n"; ?>
<!--eof Form start-->
...
<!--eof Product details list -->
   ...
   <br />
   <b><?php echo '<a href="' . zen_href_link(FILENAME_ASK_A_QUESTION, 'products_id=' . $_GET['products_id']) . '"><span style="color:#0000ff;">Pregúntenos sobre este producto</span></a>'; ?></b>
   </span>
   <br class="clearBoth" />
