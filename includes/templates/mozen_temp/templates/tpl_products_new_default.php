...
?>
<div id="newProductsDefaultListingTopNumber" class="navSplitPagesResult back" style="visibility: hidden;"><?php echo $products_new_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW); ?></div>
<div id="newProductsDefaultListingTopLinks" class="navSplitPagesLinks forward mj-pagination"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links(2, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></div>
...
<div class="mj-newproduct">
	<div class="mj-newproductimage">Product Image</div>
    <div class="mj-newproductname">Product Name</div>
    <div class="mj-alldefaultproductprice">Price</div>
</div>
...
?>
  <div id="newProductsDefaultListingBottomNumber" class="navSplitPagesResult back" style="visibility: hidden;"><?php echo $products_new_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW); ?></div>
  <div id="newProductsDefaultListingBottomLinks" class="navSplitPagesLinks forward mj-pagination"><?php echo TEXT_RESULT_PAGE . ' ' . $products_new_split->display_links(2, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?></div>
<?php
  }
?>
<br class="clearBoth" />
