...
document.write('<?php echo '<a href="' . zen_lightbox($products_image_large, addslashes($products_name), LARGE_IMAGE_WIDTH, LARGE_IMAGE_HEIGHT) . '" rel="' . $rel . '" title="' . addslashes($products_name) . '">' . zen_image($products_image_medium, addslashes($products_name), MEDIUM_IMAGE_WIDTH, MEDIUM_IMAGE_HEIGHT,'style="height:100% !important; width:100% !important;"') . /*'<br /><span class="imgLink">' . TEXT_CLICK_TO_ENLARGE . '</span>' .*/ '</a>'; ?>');
//--></script>
<?php } else { ?>
