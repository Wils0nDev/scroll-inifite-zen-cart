 ...
 */
  ...
  $content .= '<div id="' . str_replace('_', '-', $box_id . 'Content') . '" class="sideBoxContent mj-greybox">' . "\n";
  $content .= '<ul>' . "\n";
...
//        break;
     ...
     if (zen_get_product_types_to_category($box_categories_array[$i]['path']) == 3 or ($box_categories_array[$i]['top'] != 'true' and SHOW_CATEGORIES_SUBCATEGORIES_ALWAYS != 1)) {
      ...
      $content .= '<li style="height:80px;">';
      $content .= '<a style="height:80px;" class="' . $new_style . '" href="' . zen_href_link(FILENAME_DEFAULT.'&pg=store', $box_categories_array[$i]['path']) . '"><div style="width: 40px !important;float: left;"><img src="images/'. $box_categories_array[$i]['image'] .'" width="40" style="vertical-align:middle;" /></div><div id="imgcat" style="width: 152px;float:right;">';
//      $content .= '<a class="' . $new_style . '" href="' . zen_href_link(FILENAME_DEFAULT.'&pg=store', $box_categories_array[$i]['path']) . '" style="background:url(images/'. $box_categories_array[$i]['image'] .') fixed no-repeat;vertical-align:middle; background-size:40px;">&nbsp;&nbsp;';	  
