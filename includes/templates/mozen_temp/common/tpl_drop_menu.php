...
*/        ?>
                    ...
                    <!--<li id='mi_cuenta'><a href="<?php echo zen_href_link(FILENAME_ACCOUNT."&pg=contact_us", '', 'SSL'); ?>"><?php //echo HEADER_TITLE_MY_ACCOUNT; ?></a>-->
                    <ul class="nav-child unstyled">
                    ...
                    <li><a href="index.php?main_page=quienes_somos"><?php echo "QUIENES SOMOS"; ?></a></li>
      			    <li><a href="index.php?main_page=page_2"><?php echo "C&Oacute;MO COMPRAR"; ?></a></li>
				    <li><a href="index.php?main_page=donde_estamos"><?php echo "D&Oacute;NDE ESTAMOS"; ?></a></li>
				    <li><a href="index.php?main_page=catalogos"><?php echo "CAT&Aacute;LOGOS"; ?></a></li>
				    <li><a href="/sillas/"><?php echo "BLOG DE SILLAS"; ?></a></li>
            <li><a href="/products_new.html"><?php echo "NOVEDADES"; ?></a></li>
				    <!--<li><a href="index.php?main_page=privacy"><?php //echo "CONDICIONES DE VENTA"; ?></a></li>-->
