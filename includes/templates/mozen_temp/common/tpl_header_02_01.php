    	...
    	<div class="mj-subcontainer"><!-- mj-subcontainer -->
        	<div id="mj-logo" class="mj-grid48 mj-lspace">
				<a href="index.php?main_page=index">
					...
					<div style="float:right; margin-top: 74px; margin-right: -278px;">
            	...
            	<div class="mj-subcontainer">
            		 <div class="flexslider">
                      <ul class="slides">
                        ...
                        <!--Slide-1-->
                      	<li>
                             <div class="caption_text">
                                    <p class="flex-caption">Bancadas</p>
                                            <div class="slide-description">
                                            	<p>Bancada con asientos tapizados de dos plazas.</p>
                                            </div>
                            ...
                            <div class="slide_img">
                            	<div class="price-tag" style="background:#A52223;">
                                		<div style="color:#FFFFFF">
                                                ...
                                                <span class="price">&euro;368</span>
                                                <span class="discount"></span>
                                       </div>
                                </div>
                              <img src="<?php  echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'images').'/slideshow/3.png'?>" alt="Slide-3" />
                            </div>
                        </li>
                        <!--Slide-1 ends-->
                        <!--Slide-2-->
                      	<li>
                            <div class="caption_text">
                                        <p class="flex-caption">Sof&aacute; y Sillones</p>
                                                <div class="slide-description">
                                                	<p>Sill&oacute;n en m&eacute;duña sint&eacute;tica color caf&eacute;</p>
                                                </div>
                            ...
                            <div class="slide_img">
                            	<div class="price-tag" style="background:#23054F">
                                			 <div style="color:#FFFFFF">
                                        		<span class="tag">Precio</span>
                                                <span class="price">&euro;210</span>
                                                <span class="discount"></span>
                                            </div>
                                </div>
                                
                              <img src="<?php  echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'images').'/slideshow/9.png'?>" alt="Slide-2" />
                            </div>
                        </li>
                        <!--Slide-2 ends-->
                        <!--Slide-3-->
                        <li>
                             <div class="caption_text">
                                <p class="flex-caption">Butacas</p>
                                        <div class="slide-description">
                                        	<p>Bancada de dos plazas en PVC.</p>
                                        </div>
                            ...
                            <div class="slide_img">
                            	<div class="price-tag" style="background:#3692CA;">
                                		 <div style="color:#FFFFFF">
                                        		<span class="tag">Precio</span>
                                                <span class="price">&euro;145</span>
                                                <span class="discount"></span>
                                        </div>
                                </div>
                              <img src="<?php  echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'images').'/slideshow/1.png'?>" alt="Slide-5" />
                            </div>
                        </li>
                        <!--Slide-3 ends-->
                        <!--Slide-4-->
                        <li>
                             <div class="caption_text">
                                <p class="flex-caption">Mesas de Hosteler&iacute;a</p>
                                        <div class="slide-description">
                                        	<p>Mesa de Madera con columna central para hosteler&iacute;a</p>
                                        </div>
                            ...
                            <div class="slide_img">
                            	<div class="price-tag" style="background:#322416;">
                                		 <div style="color:#FFFFFF">
                                        		<span class="tag">Precio</span>
                                                <span class="price">&euro;115</span>
                                                <span class="discount"></span>
                                        </div>
                                </div>
                              <img src="<?php  echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'images').'/slideshow/4.png'?>" alt="Slide-4" />
                            </div>
                        </li>
                        <!--Slide-4 ends-->
                        <!--Slide-5-->
                        <li>
                            <div class="caption_text">
                                  <p class="flex-caption">Muebles Exterior</p>
                                        <div class="slide-description">
                                             <p>Mesa de diseño en polietileno rojo</p>
                                        </div>
                            ...
                            <div class="slide_img">
                            	<div class="price-tag" style="background:#FAD575;">
                                		 <div style="color:#6B5444">
                                        		<span class="tag">Precio</span>
                                                <span class="price">&euro;198</span>
                                                <span class="discount"></span>
                                        </div>
                                </div>
                              <img src="<?php  echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'images').'/slideshow/5.png'?>" alt="Slide-1" />
                            </div>
                        </li>
                        <!--Slide-5 ends-->
                      </ul>
