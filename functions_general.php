...
// show case only superceeds all other settings
    if (STORE_STATUS != '0') {
      return '<div class="productbtn" style="margin-top: -33px;"><div class="mj-productdetailimage"><a href="' . zen_href_link(FILENAME_ASK_A_QUESTION,'products_id='.$product_id) . '">' .  TEXT_SHOWCASE_ONLY . '</a></div></div>';
    }
